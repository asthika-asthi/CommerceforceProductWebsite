// ============================================================
// VENDOR LIBRARY: React + ReactDOM + JSX runtime
// ============================================================
// This file is off-the-shelf code, not written specifically for
// CommerceForce. It's the React framework (the tool that lets the
// rest of the site describe pages declaratively and update them
// efficiently) bundled together with its companion library
// ReactDOM and the small JSX runtime helper.
//
// You should not need to edit anything in this file. If you're
// looking for CommerceForce's own wording, prices, or page logic,
// it lives in the files under js/ instead.
//
// The three things the rest of the site actually uses from here
// are exported at the bottom of this file as React, ReactDOM,
// and jsx.
...
// Make the three pieces the rest of the site needs available to
// import from this file.
export { l as React, u as ReactDOM, f as jsx };
